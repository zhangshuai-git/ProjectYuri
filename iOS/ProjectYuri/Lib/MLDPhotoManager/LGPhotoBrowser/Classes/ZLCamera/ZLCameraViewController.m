...
//    CGFloat viewHeight = viewWidth / 480 * 640;;
    ...
    ZLCameraView *caramView = [[ZLCameraView alloc] initWithFrame:CGRectMake(0, 20, viewWidth, CGRectGetHeight(self.preview.frame))];
...
- (void) setup{
    ...
    topView.frame = CGRectMake(0, 0, self.view.width, 64);
