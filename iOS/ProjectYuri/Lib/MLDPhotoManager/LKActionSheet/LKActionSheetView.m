...
+ (void)sheetWithAlertTitle:(NSString *)title title1:(NSString *)title1 title2:(NSString *)title2 lkActionItem1:(LK_ACION_SHEET_ON_ITEM_TOUCH )actionItem1  lkActionItem2:(LK_ACION_SHEET_ON_ITEM_TOUCH )actionItem2 {
    ...
    [as addAction: [[LKActionItem alloc] initWithTitle: title1 onTouchBlock:actionItem1] groupIndex: 1];
    [as addAction: [[LKActionItem alloc] initWithTitle: title2 onTouchBlock: actionItem2] groupIndex: 1];
    [as show];
}
@end
